...
/**
 * \file    test/functional/SAMLFunctionalTest.php
 * \ingroup saml
 ...
 * @package Testsaml
 */
class SAMLFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	{
		$this->url('/custom/saml/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('saml/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/saml/admin/about.php');
		$this->authenticate();
		return $this->assertContains('saml/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('samlwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modSAML_SAMLTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSAML_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
