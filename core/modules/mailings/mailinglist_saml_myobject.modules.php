...
dol_include_once("/saml/class/myobject.class.php");


/**
 * mailing_mailinglist_saml
 */
class mailing_mailinglist_saml_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_saml_myobject';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('saml',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/saml/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_saml_myobject.modules.php: mailing ".$num." targets found");
