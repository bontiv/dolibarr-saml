...
/**
 * \file    saml/class/actions_saml.class.php
 * \ingroup saml
...
class ActionsSAML
{
    ...
    function getLoginPageOptions($parameters) {
        global $langs;

        $url = DOL_URL_ROOT . '/custom/saml/login.php';
        $this->results = array('table' => '<p><a href="' . $url . '">' . $langs->trans('ConnectBySaml') . '</a></p>');
    ...
    function afterLogout($parameters) {
        global $conf;
